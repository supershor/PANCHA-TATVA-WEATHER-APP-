...
public class MainActivity extends AppCompatActivity {
    ...
    public void recall() {
        ...
        if (this.sharedPreferences.getString("locality", null) != null && this.sharedPreferences.getString("city", null) != null) {
            this.toolbar.setTitle(this.sharedPreferences.getString("locality", null));
        }
